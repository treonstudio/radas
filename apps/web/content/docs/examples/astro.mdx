---
title: Astro Example
description: Radas Astro example.
---

This is an example of how to use Radas with Astro. It uses Solid for building the components.
...
<iframe src="https://stackblitz.com/github/better-auth/better-auth/tree/main/examples/astro-example?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
   ...
   title="Radas Astro+Solid Example"
