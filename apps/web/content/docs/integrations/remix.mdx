...
description: Integrate Radas with Remix.
---

Radas can be easily integrated with Remix. This guide will show you how to integrate Radas with Remix.
...
And in this file, import Radas and create your instance.
