...
description: A step-by-step guide to creating a browser extension with Radas.
---

In this guide, we'll walk you through the steps of creating a browser extension using <Link href="https://docs.plasmo.com/">Plasmo</Link> with Radas for authentication.
...
<Callout type="warn">
  ...
  <Link href="/docs/integrations/hono">a backend setup</Link> of Radas and
...
<Steps>
    ...
    <Step>
        ...
        Then, install the Radas package.
    ...
    <Step>
       ...
       <Files>
        ...
        export const authClient = createAuthClient({
            baseURL: "http://localhost:3000" /* Base URL of your Radas backend. */,
            plugins: [],
        });
        ```
    </Step>
    ...
    <Step>
        ...
        We must ensure the extension knows the URL to the Radas backend.
    ...
    <Step>
        ...
        You have now set up Radas for your browser extension.

        Add your desired UI and create your dream extension!

        To learn more about the client Radas API, check out the <Link href="/docs/concepts/client">client documentation</Link>.
...
Congratulations! You've successfully created a browser extension using Radas and Plasmo.
