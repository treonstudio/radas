...
description: A step-by-step guide to creating your first Radas plugin.
---

In this guide, we’ll walk you through the steps of creating your first Radas plugin.


<Callout type="warn">
This guide assumes you have <Link href="/docs/installation">setup the basics</Link> of Radas and are ready to create your first plugin.
</Callout>
...
<Step>
## Server plugin first
Radas plugins operate as a pair: a <Link href="/docs/concepts/plugins#create-a-server-plugin">server plugin</Link> and a <Link href="/docs/concepts/plugins#create-a-client-plugin">client plugin</Link>.
...
By creating a schema here, this also allows <Link href="/docs/concepts/cli">Radas’s CLI</Link> to generate the schemas required to update your database.
...
Congratulations! You’ve successfully created your first ever Radas plugin.
