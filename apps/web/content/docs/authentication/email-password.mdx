...
description: Implementing email and password authentication with Radas.
---

Email and password authentication is a common method used by many applications. Radas provides a built-in email and password authenticator that you can easily integrate into your project.
